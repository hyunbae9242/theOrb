...
package com.example.theorb.lwjgl3;
 ...
 * <br>
 * <a href="https://jvm-gaming.org/t/starting-jvm-on-mac-with-xstartonfirstthread-programmatically/57547">Based on this kotlin-gaming.org post by kappa</a>
 * @author damios
 */
...
// By default, LWJGL3 extracts to the directory specified by "kotlin.io.tmpdir", which is usually the user's home.
...
// We revert our changes immediately after loading LWJGL3 natives.
                ...
                String prevTmpDir = System.getProperty("kotlin.io.tmpdir", programData);
                String prevUser = System.getProperty("user.name", "libGDX_User");
                System.setProperty("kotlin.io.tmpdir", programData + "/libGDX-temp");
                System.setProperty("user.name", ("User_" + prevUser.hashCode() + "_GDX" + Version.VERSION).replace('.', '_'));
                Lwjgl3NativesLoader.load();
                System.setProperty("kotlin.io.tmpdir", prevTmpDir);
        ...
        String javaExecPath = System.getProperty("kotlin.home") + separator + "bin" + separator + "java";
        ...
        jvmArgs.add("-cp");
        jvmArgs.add(System.getProperty("kotlin.class.path"));
